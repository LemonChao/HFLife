...
//#import "HP_CakeMilkyNetApi.h"
@interface Cake_MilkyTeaVC ()<UITableViewDelegate, UITableViewDataSource>
{
//    HP_CakeMilkyNetApi *cakeMilky;
...
@implementation Cake_MilkyTeaVC
...
//                               };
//        [self getCakeMilkyDataParameter:dict ListRequestDataType:(type) successBlock:^(id  _Nonnull request) {
...
//-(void)getCakeMilkyDataParameter:(NSDictionary *)parameter ListRequestDataType:(ListRequestDataType)type successBlock:(SuccessBlock)successBlock{
//    if (!cakeMilky) {
//        cakeMilky  = [[HP_CakeMilkyNetApi alloc] initWithParameter:parameter];
//    }
//    cakeMilky.requestDataType = type;
//    [cakeMilky startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
//        HP_CakeMilkyNetApi *classifyRequest = (HP_CakeMilkyNetApi *)request;
