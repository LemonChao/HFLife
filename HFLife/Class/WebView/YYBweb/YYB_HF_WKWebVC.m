...
//        NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString_encode]];
        ...
        NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:urlString_encode] cachePolicy:NSURLRequestReloadRevalidatingCacheData timeoutInterval:20];
