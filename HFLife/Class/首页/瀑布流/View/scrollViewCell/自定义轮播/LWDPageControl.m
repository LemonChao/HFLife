...
- (void)initialize{
    ...
    _currentPageIndicatorColor = [UIColor colorWithRed:235/255.0 green:84/255.0 blue:54/255.0 alpha:1];
...
- (void)setNumberOfPages:(NSInteger)numberOfPages{
    ...
    if (_numberOfPages != numberOfPages) {
        ...
        self.contentView.frame = CGRectMake(0, Y, contentViewWidth, _indicatorHeight);
