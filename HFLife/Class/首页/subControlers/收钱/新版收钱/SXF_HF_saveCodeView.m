...
- (void)setDataForView:(id )code{
    self.codeImageV.image = [SGQRCodeObtain generateQRCodeWithData:@"哈哈哈嘻嘻嘻啊啊啊" size:self.codeImageV.bounds.size.width logoImage:[UIImage imageNamed:@"logo"] ratio:0.3];
}
