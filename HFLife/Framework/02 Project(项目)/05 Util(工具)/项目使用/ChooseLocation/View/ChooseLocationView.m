...
- (void)setUp{
    ...
    titleLabel.font = [UIFont systemFontOfSize:WidthRatio(31)];
    ...
    _underLine.backgroundColor = SUBJECTCOLOR;
...
- (void)addTopBarItem{
    ...
    topBarItem.titleLabel.font = [UIFont systemFontOfSize:WidthRatio(29)];
    [topBarItem setTitle:@"请选择" forState:UIControlStateNormal];
    [topBarItem setTitleColor:HEX_COLOR(0x222222) forState:UIControlStateNormal];
    [topBarItem setTitleColor:SUBJECTCOLOR forState:UIControlStateSelected];
