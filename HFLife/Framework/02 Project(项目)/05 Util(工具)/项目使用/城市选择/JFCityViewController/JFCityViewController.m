...
- (void)viewDidLoad {
    [super viewDidLoad];
    if (!self.isWhitei) {
        [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"meishi_bg"] forBarMetrics:UIBarMetricsDefault];
    }else{
...
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:leftButton];
    ...
    UIButton *baseRightImageButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, WidthRatio(60), HeightRatio(80))];
    [baseRightImageButton setImage:[[self imageWithOriImageName:@"back"] imageWithColor:[UIColor whiteColor]] forState:UIControlStateNormal];
    baseRightImageButton.imageView.contentMode = UIViewContentModeScaleAspectFit;
    [baseRightImageButton addTarget:self action:@selector(backrootTableViewController) forControlEvents:UIControlEventTouchUpInside];
