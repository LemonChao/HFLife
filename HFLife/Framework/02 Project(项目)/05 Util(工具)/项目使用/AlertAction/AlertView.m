...
#pragma mark - Data
@property (nonatomic, strong) NSMutableArray<AlertAction *> *actions;
...
- (void)setShowShade:(BOOL)showShade {
    ...
    _shadeView.backgroundColor = _showShade ?  [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5]: [UIColor clearColor];
//    _shadeView.backgroundColor = _showShade ? [UIColor whiteColor]:[UIColor clearColor];
}
