...
+ (void)setLinColor:(UIColor *_Nullable)color {

    [MKShowDynamic sharedInstance].showView.lineColor = color;
}

+ (void)setMessageColor:(UIColor *_Nullable)color {
    
    [MKShowDynamic sharedInstance].showView.messageColor = color;
}
+ (void)setMessageFont:(UIFont *_Nullable)font {
    [MKShowDynamic sharedInstance].showView.messageFont = font;
}
...
+ (void)showMkViewWithMessage:(NSString *)message
    ...
    if([MKShowDynamic sharedInstance].cancelColor) {
        [[MKShowDynamic sharedInstance].showView setCancelButtonColor:[MKShowDynamic sharedInstance].cancelColor];
    }
