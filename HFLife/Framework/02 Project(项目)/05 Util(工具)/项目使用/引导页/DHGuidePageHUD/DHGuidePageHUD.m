    ...
    if ([super initWithFrame:frame]) {
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.3, DDScreenH*0.9, WidthRatio(150), HeightRatio(39))];
                ...
                startButton.backgroundColor = HEX_COLOR(0x9A58D2);
...
//                [startButton setImage:[[UIImage imageNamed:@"GuideImage.bundle/guideImage_button_backgound"] imageWithColor:HEX_COLOR(0x54a8dd)] forState:UIControlStateNormal];
                ...
                [startButton mas_makeConstraints:^(MASConstraintMaker *make) {
                    ...
                    make.bottom.mas_equalTo(imageView.mas_bottom).offset(-(DDScreenH - DDScreenH*0.9));
