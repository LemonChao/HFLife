...
//    self.navigationController.navigationBar.backgroundColor = SUBJECTCOLOR;
...
- (void)setup
{
    ...
    [cancleButton setTitleColor:[UIColor groupTableViewBackgroundColor] forState:(UIControlStateNormal)];
