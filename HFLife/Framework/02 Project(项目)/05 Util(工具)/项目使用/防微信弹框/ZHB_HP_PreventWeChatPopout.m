...
@interface ZHB_HP_PreventWeChatPopout ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation ZHB_HP_PreventWeChatPopout

//
- (instancetype)initWithTitle:(NSString *)title delegate:(id<WeChatPopoutDelegate>)actionSheetViewDelegate cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...{
    self = [super init];
    if (self) {
        ...
        _cancelButtonIndex = (self.cancelButtonTitle ? self.otherButtonTitles.count + (self.destructiveButtonTitle ? 1 : 0) : -1);
            //
        [self setupXXYActionSheetViewSubviews];
    }
    return self;
}

#pragma mark - block
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtons actionSheetBlock:(WeChatPopoutViewBlock)actionSheetBlock{
    self = [super init];
    if (self) {
...
- (void)setupXXYActionSheetViewSubviews{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.font = [UIFont systemFontOfSize:WidthRatio(30)];
    return cell;
}
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView setBackgroundColor:HEX_COLOR(0x939494)];
...
- (UIButton *)cancelButton{
    if (_cancelButton == nil) {
        ...
        [_cancelButton setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithWhite:0.5 alpha:0.3]] forState:UIControlStateHighlighted];
    }
