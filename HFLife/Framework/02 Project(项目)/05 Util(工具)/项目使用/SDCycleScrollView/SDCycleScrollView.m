...
//        self.pageControl.frame = CGRectMake(0, self.frame.size.height + self.distance, self.frame.size.width, size.height);
          self.pageControl.frame = CGRectMake(0, self.frame.size.height - size.height - 10, self.frame.size.width, size.height);
    }
