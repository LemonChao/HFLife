...
//    self.titleLabel.text = model.title;
     self.titleLabel.text = @"这是一个很长很长的字 测试能否自动换行--这是一个很长很长的字 测试能否自动换行这是一个很长很长的字 测试能否自动换行这是一个很长很长的字 测试能否自动换行这是一个很长很长的字 测试能否自动换行这是一个很长很长的字 测试能否自动换行这是一个很长很长的字 测试能否自动换行";
}
