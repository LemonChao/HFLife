...
@interface ZFCollectionViewController () <ZFPlayerDelegate , UICollectionViewDelegate ,  UICollectionViewDataSource>
...
static NSString * const reuseIdentifier = @"ZFCollectionViewCell";
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"ZFCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"ZFCollectionViewCell"];
